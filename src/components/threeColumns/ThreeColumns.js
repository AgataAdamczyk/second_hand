...
const ThreeColumns = () => {
    return (
        <section className="grid__container" name="ThreeColumns" id="three__columns">
            <div className="row">
                <div className="col-21 threeColumns__content">
                    <SingleColumn 
                        columnNumber={10} 
                        columnText="Oddanych worków"
                        columnDescription="Worków z odzieżą i obuwiem (damską, męską, dziecięcą),
                        zabawkami, środkami czytości, itp."
                    />
                    <SingleColumn  
                        columnNumber={5} 
